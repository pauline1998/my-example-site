...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3>RWF ".$line_cost."</h3></strong>";
		//empty10/31/2020ontyijecho "<td><strong><h3>RWF ".$line_cost."</h3></strong>";
		echo "<td><a class='btn btn-danger btn-sm pull-right' href='cart.php?id=".$id."&action=delete'><i class='fa fa-trash-o'></i>Delete From cart</a></td>";	
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>RWF ".$total."</h2></strong></td>";
		echo "<td></td>";
...
?>
	...
	<?php echo "<button name='pay_now' type='submit' class='btn btn-inverse btn-lg' >Submit Order</button>";
