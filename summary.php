...
<!-- <div class="">
    ...
    <img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
		...
		<a href="#add" role="button" class="btn btn-info" data-toggle="modal" ><i class="icon-plus-sign icon-white"></i>Choose Payment Mode</a>

		<div id="add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Select Payment Mode</h3>
			</div>
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><select name="paymode" style="width:265px;" required>
                         <option value="">Select Material Category</option>	
						
					
				<option value="PAY AFTER">PAY AFTER DELIVERY</option> 
			...
			<div class="modal-footer">
				<input class="btn btn-primary" type="submit" name="add" value="FINISH">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
					</form>
			</div>
		</div>
		...
		<?php
			if (isset($_POST['add']))
				...
				$q1 = mysqli_query($conn, "UPDATE transaction SET paymode='$paymode' WHERE transaction_id='$tnumber'")or die(mysqli_error());
