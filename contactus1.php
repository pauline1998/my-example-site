...
<div id="video" style="background-color:#00a3e8; width:100%; height:100px;">
		<center><h3><p STYLE="color:white;"><b>Contact Us </br>--------------</hr></b></p></h3></center>
	</div>
	<br />
	<br />
		...
		<div id="content">
			<form method="post">
				<table style="position:relative; left:25%;">
					...
					<tr>
						<td style="font-size:20px;">Message:</td><td><textarea name="message" style="width:400px; height:100px;" required></textarea></td>
					</tr>
					<tr>
