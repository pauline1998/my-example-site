...
<body>
	...
	<br>
		...
		<div id="add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<h3 id="myModalLabel">Register New Product</h3>
			</div>
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Product Size" style="width:250px;" maxLength="20" required></td>
							</tr>
							...
							<tr>
								<td><input type="text" name="brand" placeholder="Brand Type" style="width:250px;" required></td>
							</tr>

							
							<tr>
								<td><select name="category" style="width:265px;" required>
                ...
                <option value="<?php echo $fetch['cat_id']?>"><?php echo $fetch['category']?></option>
				<?php
					}
				?>
                                 </select></td>
							...
							<tr>
								<td><input type="number" name="qty"  placeholder="No. In Stock" style="width:250px;" required></td>
							</tr>

							<tr>
								<td><textarea  name="description" placeholder="Product Description and Delivering Note" rows="4" cols="50"></textarea></td>
							</tr>
		...
		<?php
			if (isset($_POST['add']))
				...
				VALUES ('$product_code','$product_name','$product_price','$product_size','$name','$brand' ,'$category', '$description')");
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>MakerSpace products</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					while($fetch = mysqli_fetch_array($query))
						{
						$id = $fetch['product_id'];
						$catid = $fetch['category'];

						 $query1 = mysqli_query($conn, "SELECT * FROM `category` WHERE cat_id='$catid' ") or die(mysqli_error());
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='delete_product.php?id=".$id."' class='btn btn-danger' ><i class='icon-minus-sign icon-white'></i>Delete</a>";
					?>
					</td>
				</tr>		
				<?php
